  ...
  questions: [
{
  ...
  i18n: { gu: { q: "Petrol engine અને diesel engine વચ્ચે શું ફરક છે?" }, hi: { q: "Petrol engine और diesel engine में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Four stroke engine ના ચાર strokes સમજાવો." }, hi: { q: "Four stroke engine के चारों strokes समझाइए।" } },
...
},
{
  ...
  i18n: { gu: { q: "Hydraulic brake system કેવી રીતે કામ કરે છે?" }, hi: { q: "Hydraulic brake system कैसे काम करता है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Regular vehicle service માં તમે શું તપાસો છો?" }, hi: { q: "Regular vehicle service में आप क्या जाँचते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "ગ્રાહક કહે છે કે ગાડી ચાલુ થતી નથી. તમે problem કેવી રીતે શોધશો?" }, hi: { q: "ग्राहक कहता है कि गाड़ी स्टार्ट नहीं हो रही। आप problem कैसे ढूँढेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "Workshop માં કામ કરતી વખતે કઈ safety precautions લો છો?" }, hi: { q: "Workshop में काम करते समय कौन सी safety precautions लेते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "વાહનમાં clutch નું કામ શું છે?" }, hi: { q: "गाड़ी में clutch का काम क्या है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Engine કેમ overheat થાય છે, અને તમે શું તપાસશો?" }, hi: { q: "Engine overheat क्यों होता है, और आप क्या जाँचेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "સાચું tyre pressure શા માટે જરૂરી છે, અને કેટલા સમયે તપાસવું જોઈએ?" }, hi: { q: "सही tyre pressure क्यों ज़रूरी है, और कितने समय में जाँचना चाहिए?" } },
...
},
{
  ...
  i18n: { gu: { q: "Repair પછી એ જ problem પાછો આવ્યો હોવાથી ગ્રાહક ગુસ્સે છે. તમે કેવી રીતે સંભાળશો?" }, hi: { q: "Repair के बाद वही problem दोबारा आने से ग्राहक ग़ुस्से में है। आप कैसे संभालेंगे?" } },
