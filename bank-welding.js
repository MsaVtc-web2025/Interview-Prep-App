  ...
  questions: [
{
  ...
  i18n: { gu: { q: "Welding કરતી વખતે તમે કયાં safety equipment વાપરો છો, અને શા માટે?" }, hi: { q: "Welding करते समय आप कौन से safety equipment इस्तेमाल करते हैं, और क्यों?" } },
...
},
{
  ...
  i18n: { gu: { q: "Arc welding શું છે અને તે બે ધાતુને કેવી રીતે જોડે છે?" }, hi: { q: "Arc welding क्या है और यह दो धातुओं को कैसे जोड़ती है?" } },
...
},
{
  ...
  i18n: { gu: { q: "MIG welding અને TIG welding વચ્ચે શું ફરક છે?" }, hi: { q: "MIG welding और TIG welding में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Welding ના સામાન્ય defects કયા છે અને તે શાથી થાય છે?" }, hi: { q: "Welding के आम defects कौन से हैं और वे किस वजह से होते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Job માટે યોગ્ય current અને electrode size કેવી રીતે નક્કી કરો છો?" }, hi: { q: "Job के लिए सही current और electrode size कैसे तय करते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Welding પહેલાં joint ની તૈયારી કેવી રીતે કરો છો?" }, hi: { q: "Welding से पहले joint की तैयारी कैसे करते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Arc eye કે flash burn શું છે, અને તેનાથી કેવી રીતે બચો છો?" }, hi: { q: "Arc eye या flash burn क्या है, और उससे कैसे बचते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Welding પછી weld ની quality કેવી રીતે તપાસો છો?" }, hi: { q: "Welding के बाद weld की quality कैसे जाँचते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Gas cylinder સંભાળતી વખતે તમે કઈ precautions લો છો?" }, hi: { q: "Gas cylinder संभालते समय आप कौन सी precautions लेते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "તમે કઈ કઈ welding positions માં welding કરી શકો છો, અને કઈ સૌથી અઘરી છે?" }, hi: { q: "आप कौन कौन सी welding positions में welding कर सकते हैं, और कौन सी सबसे मुश्किल है?" } },
