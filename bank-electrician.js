  ...
  questions: [
{
  ...
  i18n: { gu: { q: "Electrical panel પર કામ કરતાં પહેલાં કઈ safety precautions લો છો?" }, hi: { q: "Electrical panel पर काम करने से पहले कौन सी safety precautions लेते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Earthing અને neutral વચ્ચે શું ફરક છે?" }, hi: { q: "Earthing और neutral में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Series connection અને parallel connection વચ્ચે શું ફરક છે?" }, hi: { q: "Series connection और parallel connection में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "ઘરનો પંખો ચાલતો નથી. તમે fault કેવી રીતે શોધશો?" }, hi: { q: "घर का पंखा नहीं चल रहा। आप fault कैसे ढूँढेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "MCB શું છે અને ELCB શું છે? બંને વચ્ચે શું ફરક છે?" }, hi: { q: "MCB क्या है और ELCB क्या है? दोनों में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Multimeter થી voltage અને current કેવી રીતે માપો છો?" }, hi: { q: "Multimeter से voltage और current कैसे मापते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "કોઈને electric shock લાગતો જુઓ તો તમે શું કરશો?" }, hi: { q: "किसी को electric shock लगता देखें तो आप क्या करेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "Connection માટે wire ની size કેવી રીતે નક્કી કરો છો?" }, hi: { q: "Connection के लिए wire की size कैसे तय करते हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "Single phase અને three phase supply વચ્ચે શું ફરક છે?" }, hi: { q: "Single phase और three phase supply में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "તમારા course દરમિયાન કોઈ practical wiring કામ કર્યું છે? તમે શું કર્યું તે સમજાવો." }, hi: { q: "अपने course के दौरान कोई practical wiring का काम किया है? आपने क्या किया, बताइए।" } },
