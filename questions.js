  ...
  questions: [
{
  ...
  i18n: { hi: { q: "Tally में purchase entry कैसे करते हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Accounting entries किस तरह की जाती हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Accounting के Golden Rules क्या हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Contra voucher क्या होता है, और उससे जुड़ी कौन सी entries होती हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Bank reconciliation क्या होता है?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपकी Tally training में क्या सिखाया गया था?" } },
...
},
{
  ...
  i18n: { hi: { q: "Online transaction कैसे करते हैं? मुझे एक-एक step बताइए।" } },
...
},
{
  ...
  i18n: { hi: { q: "Online transactions के लिए आप कौन से apps इस्तेमाल करते हैं, और उन्हें कैसे चलाते हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपकी educational qualification क्या है, और आपने कहाँ तक पढ़ाई की है?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपने अपनी degree कहाँ से ली है?" } },
...
},
{
  ...
  i18n: { hi: { q: "अपने family background के बारे में बताइए — आपके माता-पिता क्या करते हैं, और परिवार में कितने सदस्य हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपके कितने भाई-बहन हैं, और वे क्या करते हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Domestic Voice क्या होता है?" } },
...
},
{
  ...
  i18n: { hi: { q: "क्या आप night shift में काम करने के लिए तैयार हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "Voice और Non-Voice process में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { hi: { q: "अपने hometown के बारे में बताइए — आप कहाँ के रहने वाले हैं?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपके hobbies क्या हैं? आपकी रुचि किन चीज़ों में है?" } },
...
},
{
  ...
  i18n: { hi: { q: "अपने resume के 'About Me' section में आपने क्या लिखा है?" } },
...
},
{
  ...
  i18n: { hi: { q: "आपकी salary expectation क्या है?" } },
...
},
{
  ...
  i18n: { hi: { q: "अपने बारे में बताइए। संक्षेप में अपना self-introduction दीजिए।" } },
...
},
{
  ...
  i18n: { hi: { q: "पढ़ाई के साथ job कैसे manage करेंगे — full-time या part-time?" } },
