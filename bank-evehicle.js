  ...
  questions: [
{
  ...
  i18n: { gu: { q: "Electric vehicle ના મુખ્ય parts કયા કયા છે?" }, hi: { q: "Electric vehicle के मुख्य parts कौन कौन से हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "High voltage EV battery પર કામ કરતી વખતે કઈ safety precautions જરૂરી છે?" }, hi: { q: "High voltage EV battery पर काम करते समय कौन सी safety precautions ज़रूरी हैं?" } },
...
},
{
  ...
  i18n: { gu: { q: "BMS શું છે અને તે શા માટે જરૂરી છે?" }, hi: { q: "BMS क्या है और यह क्यों ज़रूरी है?" } },
...
},
{
  ...
  i18n: { gu: { q: "AC charging અને DC fast charging વચ્ચે શું ફરક છે?" }, hi: { q: "AC charging और DC fast charging में क्या फ़र्क़ है?" } },
...
},
{
  ...
  i18n: { gu: { q: "વાહન માટે petrol engine કરતાં electric motor શા માટે વધુ સારી છે?" }, hi: { q: "गाड़ी के लिए petrol engine से electric motor बेहतर क्यों है?" } },
...
},
{
  ...
  i18n: { gu: { q: "Battery full charge બતાવે છે છતાં electric scooter ચાલતું નથી. તમે શું તપાસશો?" }, hi: { q: "Battery full charge दिखा रही है फिर भी electric scooter नहीं चल रहा। आप क्या जाँचेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "EV battery લાંબો સમય ચાલે તે માટે ગ્રાહકે તેની કેવી સંભાળ રાખવી જોઈએ?" }, hi: { q: "EV battery ज़्यादा समय चले इसके लिए ग्राहक को उसकी देखभाल कैसे करनी चाहिए?" } },
...
},
{
  ...
  i18n: { gu: { q: "EV battery માંથી ધુમાડો નીકળે કે આગ લાગે તો તમે શું કરશો?" }, hi: { q: "EV battery से धुआँ निकलने लगे या आग लग जाए तो आप क्या करेंगे?" } },
...
},
{
  ...
  i18n: { gu: { q: "Regenerative braking શું છે?" }, hi: { q: "Regenerative braking क्या है?" } },
...
},
{
  ...
  i18n: { gu: { q: "તમે electric vehicle industry માં કેમ કામ કરવા માંગો છો?" }, hi: { q: "आप electric vehicle industry में क्यों काम करना चाहते हैं?" } },
