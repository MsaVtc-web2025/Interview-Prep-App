...
en: {
  ...
  "status.transcribing": "Reading your answer…",
  "dict.endingIn": "Recording stops in {n} seconds — press the button when you are done.",
  "status.listening": "Listening… speak in English",
  "status.listenFree": "Listening… answer in your own words",
  "err.noVoice": "No working voice on this phone, so the question could not be read aloud. Read it above, then tap “Answer”. To fix it: Settings → Language & input → Text-to-speech.",
  "run.answerLabelFree": "Your answer",
  "run.typePlaceholderFree": "Type your answer here.",
  "res.needsNet": "This answer needs internet to be marked. Try again when you are online, or answer in English.",
  ...
  "help.a4": "In English mode, yes. With the app set to Gujarati or Hindi you may answer in your own language on most questions, and you are marked on what you actually said — only the self-introduction questions ask for English, because that is what a real interviewer expects. Change the app language in Settings.",
  ...
  "ai.sends": "While this is on, the answer you speak is sent to an AI service to be marked. Your name is never sent. Turn it off and nothing you say leaves this phone — marking still works, fully offline.",
...
gu: {
  ...
  "status.transcribing": "તમારો જવાબ વંચાય છે…",
  "dict.endingIn": "રેકોર્ડિંગ {n} સેકન્ડમાં બંધ થશે — પૂરું થાય એટલે બટન દબાવો.",
  "status.listening": "સાંભળી રહ્યા છીએ… અંગ્રેજીમાં બોલો",
  "status.listenFree": "સાંભળી રહ્યા છીએ… તમારા શબ્દોમાં જવાબ આપો",
  "err.noVoice": "આ ફોનમાં કોઈ વોઇસ ચાલતો નથી, તેથી પ્રશ્ન બોલાયો નહીં. ઉપર વાંચીને «જવાબ આપો» દબાવો. ઠીક કરવા: Settings → Language & input → Text-to-speech.",
  "run.answerLabelFree": "તમારો જવાબ",
  "run.typePlaceholderFree": "જવાબ અહીં ટાઇપ કરો.",
  "res.needsNet": "આ જવાબ તપાસવા ઇન્ટરનેટ જોઈએ. ઇન્ટરનેટ આવે ત્યારે ફરી પ્રયત્ન કરો, અથવા અંગ્રેજીમાં જવાબ આપો.",
  ...
  "ai.sends": "આ ચાલુ હોય ત્યાં સુધી તમે બોલેલો જવાબ તપાસવા માટે AI સેવા પર જાય છે. તમારું નામ કદી મોકલાતું નથી. બંધ કરશો તો તમે બોલેલું કંઈ પણ આ ફોનની બહાર જતું નથી — મૂલ્યાંકન તો પૂરેપૂરું ઓફલાઇન થાય જ છે.",
...
hi: {
  ...
  "status.transcribing": "आपका जवाब पढ़ा जा रहा है…",
  "dict.endingIn": "रिकॉर्डिंग {n} सेकंड में बंद होगी — पूरा हो जाए तो बटन दबाएँ।",
  "status.listening": "सुन रहे हैं… अंग्रेज़ी में बोलें",
  "status.listenFree": "सुन रहे हैं… अपने शब्दों में जवाब दें",
  "err.noVoice": "इस फ़ोन में कोई चालू आवाज़ नहीं है, इसलिए प्रश्न बोलकर नहीं पढ़ा जा सका। ऊपर पढ़ें, फिर «जवाब दें» दबाएँ। ठीक करने के लिए: Settings → Language & input → Text-to-speech.",
  "run.answerLabelFree": "आपका जवाब",
  "run.typePlaceholderFree": "जवाब यहाँ टाइप करें।",
  "res.needsNet": "इस जवाब को जाँचने के लिए इंटरनेट चाहिए। इंटरनेट आने पर फिर कोशिश करें, या अंग्रेज़ी में जवाब दें।",
  ...
  "ai.sends": "यह चालू रहने तक आपका बोला हुआ जवाब जाँच के लिए AI सेवा को भेजा जाता है। आपका नाम कभी नहीं भेजा जाता। बंद कर देंगे तो आपका बोला हुआ कुछ भी इस फ़ोन से बाहर नहीं जाता — मूल्यांकन तब भी पूरी तरह ऑफ़लाइन होता है।",
