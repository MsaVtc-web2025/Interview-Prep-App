...
en: {
  ...
  "rev.pendTitle": "Feedback under review",
  "rev.pendBody": "Your answer is being checked. You can move on to the next question — all your feedback is shown together at the end.",
  "rev.spoken": "Your feedback is under review. You may move on to the next question.",
  "rev.title": "Your feedback",
  "rev.lead": "Here is the feedback for every answer you gave in this session.",
  "rev.waiting": "Finishing the last check…",
  "rev.empty": "Nothing to show yet.",
  "rev.offline": "Checked offline",
  "rev.done": "Done",
...
gu: {
  ...
  "rev.pendTitle": "તપાસ ચાલુ છે",
  "rev.pendBody": "તમારો જવાબ તપાસાઈ રહ્યો છે. તમે આગળના પ્રશ્ન પર જઈ શકો છો — બધું મૂલ્યાંકન અંતે એક સાથે દેખાશે.",
  "rev.spoken": "તમારા જવાબની તપાસ ચાલુ છે. તમે આગળના પ્રશ્ન પર જઈ શકો છો.",
  "rev.title": "તમારું મૂલ્યાંકન",
  "rev.lead": "આ સત્રમાં તમે આપેલા દરેક જવાબનું મૂલ્યાંકન અહીં છે.",
  "rev.waiting": "છેલ્લી તપાસ પૂરી થઈ રહી છે…",
  "rev.empty": "હજુ કશું બતાવવાનું નથી.",
  "rev.offline": "ઓફલાઇન તપાસ્યું",
  "rev.done": "પૂરું",
...
hi: {
  ...
  "rev.pendTitle": "जाँच चल रही है",
  "rev.pendBody": "आपका जवाब जाँचा जा रहा है। आप अगले सवाल पर जा सकते हैं — पूरा मूल्यांकन अंत में एक साथ दिखेगा।",
  "rev.spoken": "आपके जवाब की जाँच चल रही है। आप अगले सवाल पर जा सकते हैं।",
  "rev.title": "आपका मूल्यांकन",
  "rev.lead": "इस सत्र में आपने जो भी जवाब दिए, उन सबका मूल्यांकन यहाँ है।",
  "rev.waiting": "आख़िरी जाँच पूरी हो रही है…",
  "rev.empty": "अभी दिखाने के लिए कुछ नहीं है।",
  "rev.offline": "ऑफ़लाइन जाँचा",
  "rev.done": "पूरा",
